...
export class CreateAutomatSettingValidator {
  ...
  public schema = schema.create({
    ...
    fiscalization: schema.object.optional().members({
      ...
      automatNumber: schema.string.optional({ trim: true }),
...
export class DeleteAutomatValidator {
  constructor(protected ctx: HttpContextContract) {}
   ...
   */
  public schema = schema.create({
    automatsId: schema.array().members(schema.number()),
  })
...
export class MoveAutomatsValidator {
  constructor(protected ctx: HttpContextContract) {}
